  ...
  <header class="bg-black sticky top-0 z-50 shadow-md transition-all duration-300 w-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between transition-all duration-300" :class="isScrolled ? 'h-16' : 'h-20'">
      ...
      <div class="hidden md:flex flex-1 justify-end">
        ...
        <a :href="'https://wa.me/' + usePage().props.global_whatsapp + '?text=' + encodeURIComponent('¡Hola! Estoy en la web de Tersal y necesito asesoría inmediata.')" target="_blank" class="flex items-center gap-3 font-semibold text-white hover:text-gray-300 transition-colors cursor-pointer text-sm tracking-wide justify-end translate-x-4 lg:translate-x-8">
          <!-- WhatsApp SVG Logo -->
